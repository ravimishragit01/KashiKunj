...
const boats = [
  {
    ...
    description: "Morning boat ride to witness sunrise over Ganga.",
    highlights: [
      "Departs from Assi Ghat — 50 meters from our property",
      "Best views of sunrise over the Ganga",
      "Life jackets provided",
      "Ideal before breakfast, 6:00–7:00 AM start",
    ],
  },
  {
